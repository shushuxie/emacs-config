...
(custom-set-variables
 ...
 '(package-selected-packages
   '(which-key yasnippet winum valign use-package-hydra undo-tree treemacs-projectile treemacs-magit treemacs-icons-dired smart-mode-line rime rg rainbow-delimiters quickrun osx-clipboard org-super-agenda org-download org-bullets org-appear mwim marginalia lsp-ui ivy-posframe highlight-symbol good-scroll git-gutter-fringe flycheck evil-leader evil-escape doom-themes dirvish dired-subtree diff-hl dashboard counsel-projectile company-box cdlatex ccls auctex amx ace-pinyin))
