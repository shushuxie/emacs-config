;;; flycheck-pkg-config-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(register-definition-prefixes "flycheck-pkg-config" '("flycheck-pkg-config-"))
